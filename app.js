...
message.channel.send('The bot Ping have -108 ms');
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField('Guilds', bot.guilds.size, true)
        .addField('Users', bot.users.size.toLocaleString(), true)
        .addField('Creator', 'ForgotenDemons  ', true)
        .addField('Helping', 'Lescending  ', true)
        .addField('Developer', 'UK_0PERATOR  ', true)
        .addField('Discord Server', 'https://discord.gg/hkTtHRq', true)
